...
from craft_parts.repo import apt_ppa, errors
from craft_parts.repo.apt_key_manager import AptKeyManager
...
@mock.patch("craft_parts.repo.apt_key_manager.AptKeyManager.is_key_installed")
@pytest.mark.parametrize(
    "is_installed",
    [True, False],
)
...
@mock.patch(
    "craft_parts.repo.apt_key_manager.AptKeyManager.is_key_installed",
    return_value=False,
)
@mock.patch("craft_parts.repo.apt_key_manager.AptKeyManager.install_key")
...
@mock.patch("craft_parts.repo.apt_key_manager.AptKeyManager.install_key_from_keyserver")
