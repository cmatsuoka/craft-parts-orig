...
class SnapPackage:
    ...
    # FIXME: see https://github.com/snapcore/snapcraft/pull/3502
    #            https://github.com/snapcore/snapcraft/pull/3505
    ...
    def local_download(self, *, snap_path: str, assertion_path: str) -> None:
        ...
        if self.has_assertions():
            # calling has_assertions() should populate self._local_snap_info
            # FIXME: ensure that self._local_snap_info is populated in a more robust way
...
def _get_local_snap_file_iter(snap_name: str, *, chunk_size: int):
    ...
    try:
        ...
        raise errors.SnapdConnectionError(snap_name, url) from err
