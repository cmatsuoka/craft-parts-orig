...
"""Utilities related to URLs and downloading."""
...
def download_and_show_progress(request, destination, message=None, total_read=0):
    """A facility to download a request with nice progress bars."""
...
class _UrllibDownloader:
    ...
    # FIXME: use a callback so that the application could display the progress bar
...
def download(uri, destination, message=None):
