...
def _verify_correctly_specified(name: str):
    return (
        f"Verify the repository configuration and ensure that {name!r} "
        f"is correctly specified."
    )


def _verify_correct_syntax():
    return (
        "Verify the repository configuration and ensure that the "
    ...
    def unmarshal(cls, data: Dict[str, str]) -> "PackageRepository":
        if not isinstance(data, dict):
            raise errors.PackageRepositoryValidationError(
                ...
                resolution=_verify_correct_syntax(),
            )
    ...
    def validate(self) -> None:
        if not self.ppa:
            raise errors.PackageRepositoryValidationError(
                ...
                resolution=_verify_correctly_specified("ppa"),
            )
    ...
    def unmarshal(cls, data: Dict[str, str]) -> "PackageRepositoryAptPpa":
        ...
        if repo_type != "apt":
            raise errors.PackageRepositoryValidationError(
                ...
                resolution=_verify_correctly_specified("type"),
            )
    ...
    def validate(self) -> None:  # noqa: C901
            ...
            for repo_format in self.formats:
                if repo_format not in ["deb", "deb-src"]:
                    raise errors.PackageRepositoryValidationError(
                        ...
                        resolution=_verify_correctly_specified("formats"),
                    )
        ...
        if not self.key_id or not re.match(r"^[0-9A-F]{40}$", self.key_id):
            raise errors.PackageRepositoryValidationError(
                ...
                resolution=_verify_correctly_specified("key-id"),
            )
        ...
        if not self.url:
            raise errors.PackageRepositoryValidationError(
                ...
                resolution=_verify_correctly_specified("url"),
            )
        ...
        if self.suites and not self.components:
            raise errors.PackageRepositoryValidationError(
                ...
                resolution=_verify_correctly_specified("components"),
            )
        ...
        if self.components and not self.suites:
            raise errors.PackageRepositoryValidationError(
                ...
                resolution=_verify_correctly_specified("suites"),
            )
    ...
    def unmarshal(cls, data: Dict[str, Any]) -> "PackageRepositoryApt":
        ...
        if architectures is not None and (
            ...
            raise errors.PackageRepositoryValidationError(
                ...
                resolution=_verify_correctly_specified("architectures"),
            )
        ...
        if key_server is not None and not isinstance(key_server, str):
            raise errors.PackageRepositoryValidationError(
                ...
                resolution=_verify_correctly_specified("key-server"),
            )
        ...
        if name is not None and not isinstance(name, str):
            raise errors.PackageRepositoryValidationError(
                ...
                resolution=_verify_correctly_specified("name"),
            )
        ...
        if path is not None and not isinstance(path, str):
            raise errors.PackageRepositoryValidationError(
                ...
                resolution=_verify_correctly_specified("path"),
            )
