...
class Snap(FileSourceHandler):
    ...
    def __init__(
        ...
        *,
        ...
        if source_tag:
            raise errors.InvalidSourceOption("snap", "source-tag")

        if source_commit:
            raise errors.InvalidSourceOption("snap", "source-commit")

        if source_branch:
            raise errors.InvalidSourceOption("snap", "source-branch")
...
def _get_snap_name(snap_dir: str) -> str:
    try:
        ...
        raise errors.InvalidSnapPackage() from snap_error
