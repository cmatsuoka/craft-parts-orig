...
from craft_parts.repo import errors
...
def test_apt_unmarshal_invalid_extra_keys():
    ...
    assert (
        exc_info.value.resolution
        == "Verify the repository configuration and ensure it is correct."
    )
...
def test_apt_unmarshal_invalid_type():
    ...
    assert exc_info.value.resolution == (
        "Verify the repository configuration and ensure that 'type' "
        "is correctly specified."
    )
...
def test_ppa_invalid_ppa():
    ...
    assert exc_info.value.resolution == (
        "Verify the repository configuration and ensure that 'ppa' "
        "is correctly specified."
    )
